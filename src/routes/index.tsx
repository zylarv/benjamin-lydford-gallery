    ...
    <SiteLayout>
          ...
          <div className="absolute inset-x-0 bottom-0 px-6 md:px-10 pb-10 md:pb-16">
            <div className="mx-auto max-w-[1400px] flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              <div>
                ...
                <h1 className="font-display text-4xl md:text-6xl text-background mt-4 max-w-3xl leading-[1.05] animate-fade-up delay-500">
                  Earth, memory and quiet weather, held in paint.
                </h1>
              </div>
              <div className="flex gap-4 text-xs uppercase tracking-[0.2em] animate-fade-up delay-700">
                <Link
                  to="/available"
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-20 md:py-28 grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-7">
          <p className="font-display text-2xl md:text-3xl leading-[1.35] text-foreground animate-fade-up delay-100">
